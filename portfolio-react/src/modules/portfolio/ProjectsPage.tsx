...
function ProjectCard({
  ...
  // Parallax on the index number
  const numY = useTransform(scrollYProgress, [0, 1], [-18, 18]);
  // Subtle card raise as it enters viewport
  ...
  return (
    ...
    >
      {/* Outer glow that pulses in on view */}
      <motion.div
        className="absolute inset-0 rounded-[30px] pointer-events-none"
        initial={{ opacity: 0 }}
        animate={isInView ? { opacity: [0, 0.6, 0] } : {}}
        transition={{ duration: 1.8, delay: index * 0.13 + 0.3, ease: "easeOut" }}
        style={{
      ...
      <SpotlightCard
        className="group relative overflow-hidden rounded-[30px] border border-[#e5dfd6] bg-white/88 backdrop-blur-sm transition-[box-shadow,border-color,background-color] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-[#cfc6ba] hover:bg-white hover:shadow-[0_32px_80px_rgba(0,0,0,0.09)]"
      >
        {/* Top shimmer line */}
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(100deg, transparent 20%, rgba(220,208,190,0.22) 50%, transparent 80%)",
            zIndex: 1,
          }}
        />

        {/* Animated noise texture on hover */}
        <motion.div
        ...
        <div className="relative z-10 flex h-full flex-col gap-8 p-6 sm:p-8 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mb-7 flex items-center gap-4">
              ...
              {/* Animated fill line */}
              <div className="relative h-px w-10 bg-[#ddd5cb] overflow-hidden">
                <motion.span
                  className="absolute inset-y-0 left-0 bg-[#9e968c]"
                  initial={{ width: "0%" }}
                  animate={isInView ? { width: "100%" } : { width: "0%" }}
                  transition={{ duration: 0.9, delay: index * 0.13 + 0.5, ease: [0.22, 1, 0.36, 1] }}
                />
              </div>
            </div>

            {/* Title — clip reveal line by line */}
            ...
            <motion.div
              ...
              variants={{
                visible: { transition: { staggerChildren: 0.06, delayChildren: index * 0.13 + 0.4 } },
                hidden: {},
              }}
            >
              {project.tags.map((tag) => (
                <motion.span
                  ...
                  className="inline-flex items-center rounded-full border border-[#e7e0d7] bg-[#fbfaf7] px-3 py-1.5 text-[10px] uppercase tracking-[0.12em] text-[#79736b] cursor-default"
                  style={{ fontFamily: editorialFont }}
                >
                  {tag}
                </motion.span>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: index * 0.13 + 0.35, ease: [0.22, 1, 0.36, 1] }}
          >
            {/* Vertical divider that fills on hover */}
            <div className="absolute bottom-0 left-0 top-0 hidden w-px overflow-hidden bg-[#eee8df] lg:block">
              <motion.span
                ...
                transition={{ duration: 1.1, delay: index * 0.13 + 0.6, ease: [0.22, 1, 0.36, 1] }}
                viewport={{ once: true }}
              />
            </div>
        ...
        <motion.div
          className="absolute bottom-0 inset-x-0 h-[1.5px] bg-gradient-to-r from-transparent via-[#b8ae9f] to-transparent origin-center"
          initial={{ scaleX: 0 }}
          whileHover={{ scaleX: 1 }}
    ...
    <>
      ...
      >
        ...
        <section id="about" className="relative scroll-mt-28 bg-white py-28 overflow-hidden">
          ...
          {/* Animated radial gradient that follows scroll */}
          <motion.div
            className="pointer-events-none absolute inset-0"
            initial={{ opacity: 0 }}
            ...
            style={{
              background: "radial-gradient(ellipse 60% 50% at 80% 20%, rgba(186,176,163,0.13) 0%, transparent 70%)",
            }}
          />

          {/* Large number watermark that slides in */}
          ...
          <div className="mx-auto max-w-5xl px-6 sm:px-8">
            ...
            {/* Cards grid — full cinematic entrance */}
            <div className="grid gap-0 md:grid-cols-2">
              {page.experience.map((item, index) => (
                ...
                >
                  <SpotlightCard
                    className="group relative border-t border-[#e8e4de] p-8 transition-[background-color,box-shadow] duration-500 hover:bg-[#fcfbf8] hover:shadow-[0_24px_64px_rgba(0,0,0,0.07)] first:border-t-0 md:first:border-t md:[&:nth-child(2)]:border-t-0 md:odd:border-r md:border-r-[#e8e4de] overflow-hidden"
                  >
                    ...
                    <motion.div
                      className="absolute inset-x-0 top-0 h-[1.5px] bg-gradient-to-r from-transparent via-[#b8ae9f] to-transparent origin-left"
                      initial={{ scaleX: 0 }}
                      whileHover={{ scaleX: 1 }}
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="overflow-hidden mb-3">
                        <motion.h3
                          className="max-w-[22ch] text-[1.04rem] font-normal leading-[1.5] text-[#171717] group-hover:text-[#000] transition-colors duration-200"
                          style={{ fontFamily: editorialFont }}
            ...
            {/* Bottom divider that draws itself */}
            <motion.div
        ...
        <section id="projects" className="relative scroll-mt-28 bg-[#f7f6f3] py-32 overflow-hidden">
          ...
          {/* Animated background orb that drifts */}
          <motion.div
            className="pointer-events-none absolute -left-40 top-1/3 h-[600px] w-[600px] rounded-full"
            animate={{ x: [0, 40, 0], y: [0, -30, 0] }}
            transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
            style={{
              background: "radial-gradient(circle, rgba(186,176,163,0.09) 0%, transparent 70%)",
            }}
          />
          <motion.div
            ...
            style={{
              background: "radial-gradient(circle, rgba(160,152,142,0.07) 0%, transparent 70%)",
            }}
          />

          {/* Massive watermark — slides from left */}
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <motion.span
          ...
          <div className="mx-auto max-w-6xl px-6 sm:px-8">
            ...
            >
              <motion.div
                ...
                viewport={{ once: true }}
              />
              <span className="text-[10px] uppercase tracking-[0.22em] text-[#a09890]" style={{ fontFamily: editorialFont }}>
...
function HeroInteractiveLayerSection() {
  ...
  const [ripple, setRipple] = useState<{ id: number; x: number; y: number }[]>([]);
